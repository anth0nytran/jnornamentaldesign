...
import serviceGateDriveway from '../assets/hero-luxury-gate.png';
import serviceGatePedestrian from '../assets/service-gate.png';
import serviceGateSecurity from '../assets/fence-chainlink-black-pro.png';
import serviceGateDecorative from '../assets/fence-iron-estate-pro.png';
        ...
        <div className="bg-white font-body selection:bg-amber-500 selection:text-black overflow-x-hidden">
            ...
            <section className="relative min-h-[90vh] flex items-center bg-iron-900 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img src={gatesHero} alt="Custom Driveway Gates Houston" className="w-full h-full object-cover opacity-60" />
            ...
            <section className="py-24 bg-iron-900 relative overflow-hidden">
                <div className="container mx-auto px-6 max-w-7xl relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4 uppercase">Houston Gate Installation Reviews</h2>
                        <div className="flex items-center justify-center gap-2 text-amber-500 mb-4">
                            {[...Array(5)].map((_, i) => <StarIcon key={i} className="w-5 h-5" filled />)}
                        </div>
                        <p className="text-gray-400 font-body normal-case">See what Houston homeowners say about our gates.</p>
                    </div>
