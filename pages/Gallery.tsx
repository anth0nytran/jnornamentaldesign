...
// ── Gallery data ─────────────────────────────────────────────
// Just append new images to this array as they arrive.
// No ordering needed — they display in the order listed.
const GALLERY_IMAGES = [
    ...FEATURED_PROJECTS,
    // Add more images here as the client provides them:
    // { src: '/path/to/photo.jpg', alt: 'Description', category: 'Gates' },
];
                        ...
                        <AnimatePresence mode="popLayout">
                            {filtered.map((img, idx) => (
                                <motion.div
                                    ...
                                    className="group relative overflow-hidden rounded-lg bg-gray-200 shadow-md hover:shadow-2xl transition-all duration-500 aspect-[4/3] cursor-pointer"
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-0 left-0 p-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                                        ...
                                        <h3 className="text-white font-display text-lg font-bold leading-tight">{img.alt}</h3>
                                    </div>
                                    {/* Number badge */}
