        ...
        <div className="bg-white">
            ...
            <section className="relative h-[65vh] min-h-[500px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                    ...
                    <p className="text-xl md:text-2xl text-slate-100 font-light max-w-2xl mx-auto mb-10 leading-relaxed shadow-black drop-shadow-md">
                        Take command of your property. Advanced gate automation and entry systems installed by certified experts.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="#contact" className="bg-amber-500 hover:bg-amber-400 text-navy-950 px-10 py-4 font-bold rounded-lg transition-transform hover:scale-105 shadow-xl flex items-center justify-center gap-2">
                            Request Consult <ArrowRightIcon className="w-5 h-5" />
                        </a>
                    </div>
                </div>
            </section>
            ...
            <section id="services">
                ...
                <div className="bg-white py-16 text-center px-6">
                    <span className="text-amber-600 font-bold uppercase tracking-widest text-xs mb-3 block">System Options</span>
                    <h2 className="font-display text-4xl font-bold text-navy-950">Security Solutions</h2>
                ...
                <div className="flex flex-col">
                    {category.services.map((service, idx) => {
                        const Icon = ServiceIcons[service.icon] || ServiceIcons.gear;
                                    ...
                                    <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 lg:gap-20 items-center`}>
                                        ...
                                        <div className="lg:w-1/2 w-full">
                                            ...
                                            <p className="text-lg text-slate-600 leading-relaxed mb-8">
                                                {service.description} Integrated seamlessly with your home automation or standalone for maximum reliability.
                                            </p>
                ...
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                        <div className="max-w-xl">
                            <h2 className="font-display text-4xl font-bold mb-4">Live Installations</h2>
                            <p className="text-slate-400 text-lg">
                                Clean wiring, professional mounting, and robust daily operation.
                            </p>
                        </div>
                        <a href="#contact" className="text-amber-500 font-bold hover:text-amber-400 transition-colors flex items-center gap-2">
                            Get System Quote <ArrowRightIcon className="w-5 h-5" />
                        </a>
                    </div>
            ...
            <section id="contact" className="relative bg-white py-24 lg:py-32">
                <div className="container mx-auto px-6 max-w-4xl relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="font-display text-4xl md:text-6xl font-bold text-navy-950 mb-6">Upgrade Your Security</h2>
                        <p className="text-xl text-slate-500 max-w-2xl mx-auto">
                            Don't leave your property vulnerable. Get a professional assessment and quote today.
                        </p>
                    </div>
