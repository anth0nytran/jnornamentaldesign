        ...
        <div className="bg-white">
            ...
            <section className="relative h-[65vh] min-h-[500px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                    ...
                    <p className="text-xl md:text-2xl text-slate-100 font-light max-w-2xl mx-auto mb-10 leading-relaxed shadow-black drop-shadow-md">
                        Privacy, security, and elegance. Built with premium materials to withstand the Texas climate.
                    </p>
            ...
            <section id="services">
                ...
                <div className="bg-white py-16 text-center px-6">
                    <span className="text-amber-600 font-bold uppercase tracking-widest text-xs mb-3 block">Comparison Guide</span>
                    <h2 className="font-display text-4xl font-bold text-navy-950">Choose Your Material</h2>
                ...
                <div className="flex flex-col">
                    {category.services.map((service, idx) => {
                        const Icon = ServiceIcons[service.icon] || ServiceIcons.fence;
                                    ...
                                    <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 lg:gap-20 items-center`}>
                                        ...
                                        <div className="lg:w-1/2 w-full">
                                            ...
                                            <p className="text-lg text-slate-600 leading-relaxed mb-8">
                                                {service.description} We hand-select materials to ensure minimal warping and maximum durability.
                                            </p>
                ...
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                        <div className="max-w-xl">
                            <h2 className="font-display text-4xl font-bold mb-4">Our Methodology</h2>
                            <p className="text-slate-400 text-lg">
                                Visual evidence of our commitment to quality. Note the straight lines, even spacing, and clean job sites.
                            </p>
                        </div>
            ...
            <section id="contact" className="relative bg-white py-24 lg:py-32">
                <div className="container mx-auto px-6 max-w-4xl relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="font-display text-4xl md:text-6xl font-bold text-navy-950 mb-6">Ready to Build?</h2>
                        <p className="text-xl text-slate-500 max-w-2xl mx-auto">
                            Get a firm price quote with no hidden fees. We respect your time and property.
                        </p>
                    </div>
